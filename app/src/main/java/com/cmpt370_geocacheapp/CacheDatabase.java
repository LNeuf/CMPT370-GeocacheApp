package com.cmpt370_geocacheapp;s
...
public class CacheDatabase {
    ...
    public static void main(String[] args) {
        ...
        PhysicalCacheObject cache1 = new PhysicalCacheObject(cache1Object,14.007, 14.003, "Hard", "Hilly");
        database.addPhysicalCache(cache1);

        CacheObject cache2Object = new CacheObject("Regina Cache", user,802);
        PhysicalCacheObject cache2 = new PhysicalCacheObject(cache2Object,15.032, 16.704, "Easy", "Flat");
